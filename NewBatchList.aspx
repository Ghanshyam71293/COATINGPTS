                             ...
                             <ItemTemplate>
                                 ...
                                 <tr style="background-color:darksalmon;">
                                  ...
                                  <tr style="background-color:darksalmon;">
                                     <th>Length FT:</th>
                                     <td>
                                           <asp:TextBox ID="txtLengthft"  CssClass="form-control "  Font-Size="Larger"   Height="75px" placeholder="Length FT" runat="server"></asp:TextBox>
                                  ...
                                  <tr style="background-color:darksalmon;">
                                     <th>Weight:</th>
                                     <td>
                                           <asp:TextBox ID="txtWeight"  CssClass="form-control "  Font-Size="Larger"   Height="75px" placeholder="Weight" runat="server"></asp:TextBox>
...
<img id="imgdiv" width="30px" border="0" src="plus.gif" />
                               ...
                               <tr  id="tr1" style="background-color: antiquewhite;">
                                      ...
                                      <tr id="tr8" style="background-color: antiquewhite;">
                                          <th>HOLIDAY DETECTOR VOLTAGE:</th>
                                          <td>
                      ...
                      <div class="row">
                           <div class="col-md-6" >
                        Sale Order<asp:TextBox ID="txtsaleorder" ReadOnly="true" runat="server"></asp:TextBox>
                        
                      
                    </div>
                    <div class="col-md-6" >
                      LineItem  <asp:TextBox ID="txtlineitem" ReadOnly="true" runat="server"></asp:TextBox>
