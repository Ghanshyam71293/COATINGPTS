...
{
    public partial class ReleaseScan : System.Web.UI.Page
    {
        ...
        public static void SaveUser(List<Customer> customers)
        {
            ...
            DataTable dt = (DataTable)(HttpContext.Current.Session["NewRELEASEBatch"]);
            if (customers == null)
            {
            ...
            foreach (Customer c in customers)
            {
                ...
                dt.Rows.Add(dr);
                HttpContext.Current.Session["NewRELEASEBatch"] = dt;
