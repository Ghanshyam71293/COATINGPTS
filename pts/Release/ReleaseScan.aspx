<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReleaseScan.aspx.cs" Inherits="PTSCOATING.pts.Release.ReleaseScan" %>
...
<body data-instant-allow-query-string="" data-instant-allow-external-links="">
    ...
    <header class="app-header">
        <%-- <a class="app-header__logo"  href="../homepage.aspx" > <image style="width:213px; height:80px"    src="https://apps.jindalsaw.com/claim/Jindal_Logo.jpg"></image> </a>
           &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b align="center" style="background-color:#009688;   width:900px ;font-family:Arial; font-size:49px">RELEASE SCANNER</b>--%>
        ...
        <b class="app-menu__label" style="color: #ffffff!important; text-align: center!important; line-height: 2.1!important; flex: 5 1 auto!important; font-size: 35px;">RELEASE <%=Session["StationType"].ToString()%> SCANNER</b>
                    ...
                    <div class="col-md-12" style="text-align: center; margin-bottom: 20px;">
                        <div id="reader" style="display: inline-block; position: relative; padding: 0px; border: 1px solid silver;">
                            <div style="text-align: left; margin: 0px;">
                                <div style="position: absolute; top: 10px; right: 10px; z-index: 2; display: none; padding: 5pt; border: 1px solid silver; font-size: 10pt; background: rgb(248, 248, 248) none repeat scroll 0% 0%;"></div>
                                ...
                                <div id="reader__header_message" style="display: none; text-align: center; font-size: 14px; padding: 2px 10px; margin: 4px; border-top: 1px solid rgb(246, 246, 246); background: rgba(0, 0, 0, 0) none repeat scroll 0% 0%; color: rgb(17, 17, 17);">Requesting camera permissions...</div>
                            </div>
                            <div id="reader__scan_region" style="width: 100%; min-height: 100px; text-align: center; position: relative;">
                                <video style="width: 640px;" muted="true"></video>
                                <canvas style="width: 250px; height: 250px; display: none;" id="qr-canvas" width="250" height="250"></canvas>
                                <div style="position: absolute; border-color: rgba(0, 0, 0, 0.48); border-style: solid; border-width: 115px 195px; box-sizing: border-box; inset: 0px;" id="qr-shaded-region">
                                ...
                                <div style="display: none; position: absolute; top: 0px; z-index: 1; background: yellow none repeat scroll 0% 0%; text-align: center; width: 100%;">Scanner paused</div>
                            </div>
                            <div id="reader__dashboard" style="width: 100%;">
                                <div id="reader__dashboard_section" style="width: 100%; padding: 10px 0px; text-align: left;">
                                    <div>
                                        <div id="reader__dashboard_section_csr" style="display: block; text-align: center;"><span style="margin-right: 10px;">
                                            <select style="display: none;" id="reader__camera_selection" disabled="disabled">
                                                <option value="xApzS2dowobLVkvwregPRdq0+I580UGU2pHFmGlTCeU=" selected="selected">Integrated Webcam</option>
                                            </select></span><span>
                                                <button style="opacity: 1; display: none;">Start Scanning</button>
                                                <button style="display: inline-block;">Stop Scanning</button></span></div>
                                        <div id="reader__dashboard_section_fsr" style="text-align: center; display: none;">
                                            <input id="reader__filescan_input" accept="image/*" type="file" style="width: 200px;" disabled="disabled"><span> Select Image</span></div>
                                    </div>
                                    <div style="text-align: center;"><a style="text-decoration: underline; display: none;" id="reader__dashboard_section_swaplink" href="#scan-using-file">Scan an Image File</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="empty"></div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12" style="text-align: center; margin-bottom: 20px;">
                        ...
                        <br />
                        <div class="col-md-12">
                            <a href="MultipleRelease.aspx" style="font-size: 36px; width: 400px" class="btn btn-primary">Multiple Release</a>
                        </div>
                        <br />
                        <br />

                        <div class="col-md-12">
                            <a href="ReleaseScan.aspx" style="font-size: 36px; width: 400px" class="btn btn-danger">Reset</a>
                        </div>
                        <br />
                        <br />
                        <div class="col-md-12">
