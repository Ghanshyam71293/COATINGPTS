    ...
    public partial class AcidScan : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Session["NewSolutionSaltBatch"] = dt;
            }
        }
        ...
        public static void SaveUser(List<Customer> customers)
        {
            ...
            DataTable dt = (DataTable)(HttpContext.Current.Session["NewSolutionSaltBatch"]);
            if (customers == null)
            {
            ...
            foreach (Customer c in customers)
            {
                ...
                dt.Rows.Add(dr);
                HttpContext.Current.Session["NewSolutionSaltBatch"] = dt;
