<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TakePicture.aspx.cs" Inherits="PTSCOATING.pts.CALBRATION.TakePicture" %>
...
<body>
     <header class="app-header">
           ...
           &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b align="center" style="background-color:#009688;   width:900px ;font-family:Arial; font-size:49px">Acid Wash <%=Session["StationType"].ToString()%> Camera</b>--%>
           <a class="app-header__logo" style="background-color:#009688!important;"  href="../homepage.aspx"> 
             ...
             <b class="app-menu__label" style="color:#ffffff!important;text-align:center!important;line-height:2.1!important;flex: 5 1 auto!important;font-size:35px;">CALIBRATION <%=Session["StationType"].ToString()%> CAMERA</b>
            ...
            <table>
               ...
               &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;     &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; <a href="TakePicture.aspx" style="font-size: 36px; width: 400px" class="btn btn-danger">Reset</a>
                ...
                <tr>
                 ...
                 <tr>
                    <td valign="top">
               &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;     &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; <a href="AcidScan.aspx" style="font-size: 36px; width: 400px" class="btn btn-dark">Back</a>
                        </td>
                </tr>
                 <script src="https://ajax.microsoft.com/ajax/jquery/jquery-1.4.2.js" type="text/javascript"></script>  
                <script type="text/javascript">
