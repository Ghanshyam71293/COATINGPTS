<%@ Page Title="" Language="C#" MasterPageFile="~/pts/BLASTING/BLASTING.Master" AutoEventWireup="true" CodeBehind="NewBatchList.aspx.cs" Inherits="PTSCOATING.pts.BLASTING.NewBatchList" %>
...
<img id="imgdiv" width="30px" border="0" src="plus.gif" />
                               ...
                               <tr  id="tr1" style="background-color: antiquewhite;">
                                      ...
                                      <tr id="tr4" style="background-color: antiquewhite;">
                                          ...
                                          <td>
                                              <asp:TextBox ID="txtParameter4" runat="server" style="text-transform:uppercase" Font-Size="Larger"  Height="75px"  CssClass="form-control"></asp:TextBox>
                                      ...
                                      <tr id="tr6" style="background-color: antiquewhite;">
                                          ...
                                          <td>
                                              <asp:TextBox ID="txtParameter6" runat="server" Text="SSPC10/NACE-2" style="text-transform:uppercase" Font-Size="Larger"  Height="75px"  CssClass="form-control"></asp:TextBox>
                                      ...
                                      <tr id="tr9" style="background-color: antiquewhite;">
                                          <th>PIPE PRE BLAST SURFACE TEMP:</th>
                                          <td>
                                      ...
                                      <tr id="tr10" style="background-color: antiquewhite;">
                                          <th>PIPE SURFACE CONDITION AT INBOUND:</th>
                                          <td>
                                              <asp:TextBox ID="txtParameter10" runat="server" Text="SSPC SP1" style="text-transform:uppercase" Font-Size="Larger"  Height="75px"  CssClass="form-control"></asp:TextBox>
                  ...
                  <div class="row">
                    <div class="col-md-4 ">
                        <br />
                          <a type="button" class="btn btn-dark" href="BlastingScan.aspx" style="font-size: 36px; width:200px; height:85px" Font-Size="Larger"  >Back</a>
                        </div>
