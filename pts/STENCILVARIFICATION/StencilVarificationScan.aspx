<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StencilVarificationScan.aspx.cs" Inherits="PTSCOATING.pts.STENCILVARIFICATION.StencilVarificationScan" %>
...
<body data-instant-allow-query-string="" data-instant-allow-external-links="">
    ...
    <header class="app-header">
        <a class="app-header__logo" href="../homepage.aspx">
            <image style="width: 213px; height: 80px" src="https://apps.jindalsaw.com/claim/Jindal_Logo.jpg"></image>
        </a>
        &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b align="center" style="background-color: #009688; width: 900px; font-family: Arial; font-size: 49px">STENCIL VERIFICATION SCANNER</b>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12" style="text-align: center; margin-bottom: 20px;">
                        ...
                        <div class="col-md-12">
                            <a href="StencilVarificationScan.aspx" style="font-size: 36px; width: 400px" class="btn btn-danger">Reset</a>
                        </div>
                        <br />
                        <br />
                        <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        $("#btnsave").click(function () {
            ...
            if (customers.length > 0) {
                $.ajax({
                    type: "POST",
                    url: "StencilVarificationScan.aspx/SaveUser",
