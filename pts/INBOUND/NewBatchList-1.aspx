<%@ Page Title="" Language="C#" MasterPageFile="~/pts/INBOUND/INBOUND.Master" AutoEventWireup="true" CodeBehind="NewBatchList-1.aspx.cs" Inherits="PTSCOATING.pts.INBOUND.NewBatchList" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        var $input = $("#ContentPlaceHolder1_repDetails_txtcustpipeno_0");      
   ...
   <%-- <script>
        ...
        function applyAutoComplete() {
            $(".autocompletecustpipe").on("keyup", function () {
                var query = $(this).val();
                var textbox = $(this);
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.d) {
                                ...
                                var suggestionList = $('<div class="suggestion-list"></div>');

                                suggestions.forEach(function (suggestion) {
                                    suggestionList.append('<div class="suggestion-item">' + suggestion + '</div>');
                                });

                                textbox.next('.suggestion-list').remove();
                                textbox.after(suggestionList);
                            }
                        },
                        error: function () {
            ...
            $(document).on('click', '.suggestion-item', function () {
                $(".autocompletecustpipe").val($(this).text());
            ...
            $(document).on('click', function (e) {
                if (!$(e.target).closest('.autocomplete-container').length) {
                    $('.suggestion-list').remove(); // Remove suggestions if clicked outside
                }
            });
        }
    </script>  --%>
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr style="background-color: darksalmon;" id="trmtr" runat="server">
                                        ...
                                        <td>
                                            ...
                                            <%--<asp:RequiredFieldValidator ID="RFVddlmtr" runat="server" Display="None"
                                                ErrorMessage="Required" ControlToValidate="ddlmtr" InitialValue="NA" ValidationGroup="addbatch"></asp:RequiredFieldValidator>
                                            <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender6" runat="server"
                                                Enabled="true" TargetControlID="RFVddlmtr" HighlightCssClass="validatorCalloutHighlight2"
                                                CssClass="BlockPopup" />--%>
                                        </td>
                                    </tr>
                                    <tr style="background-color: darksalmon;">
                                        <th>Heat No:</th>
                                        <td>
                                            <asp:TextBox ID="txtheatdno" CssClass="form-control" ReadOnly="false" Font-Size="Larger" placeholder="Enter Heat No" runat="server"></asp:TextBox>
                                    ...
                                    <tr style="background-color: darksalmon;">
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="txtbm" CssClass="form-control" ReadOnly="false" Font-Size="Larger" placeholder="Enter Length" runat="server"></asp:TextBox>
                                    ...
                                    <tr style="background-color: darksalmon;">
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="txtbt" CssClass="form-control" ReadOnly="true" Font-Size="Larger" placeholder="Enter Weight" runat="server"></asp:TextBox>
                                    ...
                                    <tr style="background-color: darksalmon;">
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="txtcustpipeno"   Font-Size="Larger"   style="text-transform:uppercase;" CssClass="form-control autocompletecustpipe float-left" runat="server" autocomplete="off" OnTextChanged="txtcustpipeno_TextChanged" AutoPostBack="true"  ></asp:TextBox>                                            
                                        </td>                                        
