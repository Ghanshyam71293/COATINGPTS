<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InboundScan.aspx.cs" Inherits="PTSCOATING.pts.INBOUND.InboundScan" %>
...
<body data-instant-allow-query-string="" data-instant-allow-external-links="">
  <header class="site-header"   style="display:none">
      ...
      <header class="app-header">
           ...
           &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b align="center" style="background-color:#009688;   width:900px ;font-family:Arial; font-size:49px">INBOUND <%=Session["StationType"].ToString()%> SCANNER</b>--%>
           <a class="app-header__logo" style="background-color:#009688!important;"  href="../homepage.aspx"> 
             ...
             <b class="app-menu__label" style="color:#ffffff!important;text-align:center!important;line-height:2.1!important;flex: 5 1 auto!important;font-size:35px;">INBOUND <%=Session["StationType"].ToString()%> SCANNER</b>
        ...
        <div class="col-md-12" style="text-align: center;margin-bottom: 20px;">
         ...
         <div class="container">
             <div class="row">
                 <div class="col-md-12" style="text-align: center; margin-bottom: 20px;">
                      <div class="col-md-12">
                          <a href="Saleorderbatch.aspx" style="font-size: 36px; width: 400px" class="btn btn-primary">Enter SO/Line Item</a>
                         <%--<input type="button" id="btnEnterSO" style="font-size:36px; width: 400px" class="btn btn-primary" value="Enter SO/Line Item" />--%>
                     </div>
                     <br />
                     <br />
                     <div class="col-md-12">
                     ...
                     <br />
                     <div class="col-md-12">
                         <a href="InboundScan.aspx" style="font-size: 36px; width: 400px" class="btn btn-danger">Reset</a>
                     </div>
                     <br />
                     <br />
                     <div class="col-md-12">
