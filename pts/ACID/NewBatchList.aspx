<%@ Page Title="" Language="C#" MasterPageFile="~/pts/ACID/Acid.Master" AutoEventWireup="true" CodeBehind="NewBatchList.aspx.cs" Inherits="PTSCOATING.pts.ACID.NewBatchList" %>
...
<img id="imgdiv" width="30px" border="0" src="plus.gif" />
	...
	<th>TIME:</th>
	<td>
	<asp:TextBox ID="txtParameter1" TextMode="Time" runat="server" Style="text-transform: uppercase" Font-Size="Larger" Height="75px" CssClass="form-control"></asp:TextBox>
	</td>
</tr>

                                      <tr  id="tr2" class="divparameter" style="background-color: antiquewhite;">
                                          <th>PIPE TEMP (°F) PRIOR TO ACID W:</th>
                                          <td>
                                      ...
                                      <tr id="tr6" style="background-color: antiquewhite;">
                                          <th>PH OF PIPE BEFORE WATER WAS:</th>
                                          <td>
                                      ...
                                      <tr id="tr7" style="background-color: antiquewhite;">
                                          <th>PH OF PIPE AFTER WATER WASH:</th>
                                          <td>
                                      ...
                                      <tr id="tr8" style="background-color: antiquewhite;">
                                          <th>RINSE WATER PRESSURE (PSI):</th>
                                          <td>
                                      ...
                                      <tr id="tr9" style="background-color: antiquewhite;">
                                          <th>RINSE WATER CONDUCTIVITY(ΜOHMS:</th>
                                          <td>
                                  ...
                                  <tr id="tr11" style="background-color: antiquewhite;">
                                        <th>Frequency :</th>
                                        <td>
                                            <asp:TextBox ID="txtParameter11" runat="server" Style="text-transform: uppercase" Font-Size="Larger" Height="75px" onkeypress="return IsNumberWithOneDecimal(this,event);" CssClass="form-control"></asp:TextBox>
                  ...
                  <div class="row">
                    <div class="col-md-4 ">
                        <br />
                          <a type="button" class="btn btn-dark" href="AcidScan.aspx" style="font-size: 36px; width:200px; height:85px" Font-Size="Larger"  >Back</a>
                        </div>
