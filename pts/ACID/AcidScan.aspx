<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AcidScan.aspx.cs" Inherits="PTSCOATING.pts.ACID.AcidScan" %>
  ...
  <header class="site-header"   style="display:none">
      ...
      <header class="app-header">
           ...
           <a class="app-header__logo" style="background-color:#009688!important;"  href="../homepage.aspx"> 
             ...
             <b class="app-menu__label" style="color:#ffffff!important;text-align:center!important;line-height:2.1!important;flex: 5 1 auto!important;font-size:35px;">ACID WASH <%=Session["StationType"].ToString()%> SCANNER</b>
