...
namespace PTSCOATING.pts.ACID
{
    public partial class NewBatchList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Session["NewACIDBatch"] == null)
                {
                    Response.Redirect("AcidScan.aspx");
                }
                DataSet ds = new DataSet();
                parameters.Clear();
                parameters.Add("@UserId", Session["UserId"].ToString());
                ds = clsm.senddataset_Parameter("select m.*,wcm.WorkCenter,wcm.WorkStationId from login m inner join WorkCenterRightMaster wcm on m.userid=wcm.Userid where m.UserId=@UserId and WorkCenter='ACID' and m.Status=1 ", parameters);
        ...
        {
            DataTable dt = (DataTable)(Session["NewACIDBatch"]);
            if (dt.Rows.Count > 1)
            {
        ...
        protected void SendMainForm()
        {
            ...
            for (int i = 0; i < repDetails.Items.Count; i++)
            {
                ...
                if (count == 1)
                {
                    //APIPIPE += "{\r\n\"BANME\": \"" + userid + "\",\r\n \"PSTDT\": \"" + postdate + "\",\r\n \"SHIFT\": \"" + shift + "\",\r\n \"ARBPL\": \"" + WorkStationId + "\",\r\n \"CHARG\": \"" + batchno + "\",\r\n \"BSTAT\": \"" + ddlstatus.SelectedValue + "\",\r\n \"PROCT\": \"" + Stationtype + "\",\r\n \"HLDREG\": \"" + reason + "\",\r\n \"PARAM01\": \"" + txtParameter1.Text.Trim() + "\",\r\n \"PARAM02\": \"" + txtParameter2.Text.Trim() + "\",\r\n \"PARAM03\": \"" + txtParameter3.Text.Trim() + "\",\r\n \"PARAM04\": \"" + txtParameter4.Text.Trim() + "\",\r\n \"PARAM05\": \"" + txtParameter5.Text.Trim() + "\",\r\n \"PARAM06\": \"" + txtParameter6.Text.Trim() + "\",\r\n \"PARAM07\": \"" + txtParameter7.Text.Trim() + "\",\r\n \"PARAM08\": \"" + txtParameter8.Text.Trim() + "\",\r\n \"PARAM09\": \"" + txtParameter9.Text.Trim() + "\",\r\n \"PARAM10\": \"" + txtParameter10.Text.Trim() + "\",\r\n \"BLINE\": \"X\"\r\n  } \r\n ";
                    APIPIPE += "{\r\n\"BANME\": \"" + userid + "\",\r\n \"PSTDT\": \"" + postdate + "\",\r\n \"SHIFT\": \"" + shift + "\",\r\n \"ARBPL\": \"" + WorkStationId + "\",\r\n \"CHARG\": \"" + batchno + "\",\r\n \"BSTAT\": \"" + ddlstatus.SelectedValue + "\",\r\n \"PROCT\": \"" + Stationtype + "\",\r\n \"HLDREG\": \"" + reason + "\",\r\n \"PARAM01\": \"" + txtParameter1.Text.Trim() + "\",\r\n \"PARAM02\": \"" + txtParameter2.Text.Trim() + "\",\r\n \"PARAM03\": \"" + txtParameter3.Text.Trim() + "\",\r\n \"PARAM04\": \"" + txtParameter4.Text.Trim() + "\",\r\n \"PARAM05\": \"" + txtParameter5.Text.Trim() + "\",\r\n \"PARAM06\": \"" + txtParameter6.Text.Trim() + "\",\r\n \"PARAM07\": \"" + txtParameter7.Text.Trim() + "\",\r\n \"PARAM08\": \"" + txtParameter8.Text.Trim() + "\",\r\n \"PARAM09\": \"" + txtParameter9.Text.Trim() + "\",\r\n \"PARAM10\": \"" + txtParameter10.Text.Trim() + "\",\r\n \"PARAM11\": \"" + txtParameter11.Text.Trim() + "\",\r\n \"PARAM12\": \"" + txtParameter12.Text.Trim() + "\",\r\n \"BLINE\": \"X\"\r\n  } \r\n ";
            ...
            if (StatusFinal == "S")
            {
                Session["NewACIDBatch"] = null;
                repDetails.DataSource = null;
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('" + MESSAGE + "');window.location ='AcidScan.aspx';", true);
                return;
            }
            else
            {
        ...
        protected void ddlstatus_SelectedIndexChanged(object sender, EventArgs e)
        {
            for (int i = 0; i < repDetails.Items.Count; i++)
            {
                ...
                DropDownList ddlstatus = (DropDownList)repDetails.Items[i].FindControl("ddlstatus");
                parameters.Clear();
                clsm.Fillcombo_Parameter("select ReasonName,ReasonName as b from AcidStatusReason where status=1 and StatusCode='" + ddlstatus.SelectedValue + "' order by StatusCode asc", parameters, ddlreasons);
            }
        }
        protected void repDetails_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                parameters.Clear();
                clsm.Fillcombo_Parameter("select StatusName,StatusName as b from AcidstatusMaster where status=1 order by id asc", parameters, ddlstatus);
                ...
                if (statusCode1 == 0)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Server Not Respond!');window.location ='AcidScan.aspx';", true);
                    return;
                }
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Something Worng- " + response1.Content.ToString() + "');window.location ='AcidScan.aspx';", true);
                    return;
                }
                if (Status1 != "S")
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert(' " + Massage1 + "');window.location ='AcidScan.aspx';", true);
                    return;
                }
