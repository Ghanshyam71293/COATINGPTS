<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinalScan.aspx.cs" Inherits="PTSCOATING.pts.FINALINSPECTION.FinalScan" %>
...
<body data-instant-allow-query-string="" data-instant-allow-external-links="">
  <header class="site-header"   style="display:none">
      ...
      <header class="app-header">
           ...
           &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b align="center" style="background-color:#009688;   width:900px ;font-family:Arial; font-size:49px">FINAL <%=Session["StationType"].ToString()%> SCANNER</b>--%>
          <a class="app-header__logo" style="background-color:#009688!important;"  href="../homepage.aspx"> 
             ...
             <b class="app-menu__label" style="color:#ffffff!important;text-align:center!important;line-height:2.1!important;flex: 5 1 auto!important;font-size:35px;">FINAL <%=Session["StationType"].ToString()%> SCANNER</b>
             ...
             <div class="row">
                 <div class="col-md-12" style="text-align: center; margin-bottom: 20px;">
                      <div class="col-md-12" style="display:none">
                         <a href="Saleorderbatch.aspx" style="font-size: 36px; width: 400px" class="btn btn-primary">Get Next Batch</a>
                     </div>
                      <br />
                     <br />
                       <div class="col-md-12">
                         <a href="Saleorderbatch.aspx?Type=NewSaleOrder" style="font-size: 36px; width: 400px" class="btn btn-primary">Enter SO/Line Item</a>
                     </div>
                       <br />
                     <br />
                      <div class="col-md-12" >
                         <a href="parklist/GetBatch.aspx" style="font-size: 36px; width: 400px" class="btn btn-primary">Enter Park List</a>
                     </div>
                      <br />
                     <br />
                     <div class="col-md-12" style="display:none">
                     ...
                     <br />
                      ...
                      <div class="col-md-12">
                         <a href="Hold.aspx" style="font-size: 36px; width: 400px" class="btn btn-primary">HOLD</a>
                         
                     </div>
                       <br />
                     <br />
                     <div class="col-md-12">
                         <a href="Print.aspx" style="font-size: 36px; width: 400px" class="btn btn-primary">Reprint</a>
                     </div>
                     <br />
                     <br />
                     
                     <div class="col-md-12">
                         <a href="FinalScan.aspx" style="font-size: 36px; width: 400px" class="btn btn-danger">Reset</a>
                     </div>
                     <br />
                     <br />
                     <div class="col-md-12">
