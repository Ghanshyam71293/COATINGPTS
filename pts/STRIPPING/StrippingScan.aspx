<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StrippingScan.aspx.cs" Inherits="PTSCOATING.pts.STRIPPING.StrippingScan" %>
...
<body data-instant-allow-query-string="" data-instant-allow-external-links="">
  <header class="site-header"   style="display:none">
      ...
      <header class="app-header">
           ...
           &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b align="center" style="background-color:#009688;   width:900px ;font-family:Arial; font-size:49px">STRIPPING <%=Session["StationType"].ToString()%> SCANNER</b>--%>
           <a class="app-header__logo" style="background-color:#009688!important;"  href="../homepage.aspx"> 
             ...
             <b class="app-menu__label" style="color:#ffffff!important;text-align:center!important;line-height:2.1!important;flex: 5 1 auto!important;font-size:35px;">STRIPPING <%=Session["StationType"].ToString()%> SCANNER</b>
         ...
         <div class="container">
             <div class="row">
                 <div class="col-md-12" style="text-align: center; margin-bottom: 20px;">
                     ...
                     <br />
                     <div class="col-md-12">
                         <a href="StrippingScan.aspx" style="font-size: 36px; width: 400px" class="btn btn-danger">Reset</a>
                     </div>
                     <br />
                     <br />
                     <div class="col-md-12">
     ...
     <script type="text/javascript">
         ...
         $("#btnsave").click(function () {
             ...
             if (customers.length > 0) {
                  $.ajax({
                     type: "POST",
                      url: "StrippingScan.aspx/SaveUser",
